...
UNICODE_TO_CHAR  UnicodeToPcAnsiOrAscii[] = {
  ...
  { BOXDRAW_HORIZONTAL,                 0x2d, L'-' },
  //{ BOXDRAW_VERTICAL,                   0xb3, L'|' },
  { BOXDRAW_VERTICAL,                   0x7c, L'|' },
  //{ BOXDRAW_DOWN_RIGHT,                 0xda, L'/' },
  { BOXDRAW_DOWN_RIGHT,                 0x2f, L'/' },
  //{ BOXDRAW_DOWN_LEFT,                  0xbf, L'\\' },
  { BOXDRAW_DOWN_LEFT,                  0x5c, L'\\' },
  //{ BOXDRAW_UP_RIGHT,                   0xc0, L'\\' },
  { BOXDRAW_UP_RIGHT,                   0x5c, L'\\' },
  //{ BOXDRAW_UP_LEFT,                    0xd9, L'/' },
  { BOXDRAW_UP_LEFT,                    0x2f, L'/' },
  //{ BOXDRAW_VERTICAL_RIGHT,             0xc3, L'|' },
  { BOXDRAW_VERTICAL_RIGHT,             0x2b, L'+' },
  //{ BOXDRAW_VERTICAL_LEFT,              0xb4, L'|' },
  { BOXDRAW_VERTICAL_LEFT,              0x2b, L'+' },
  //{ BOXDRAW_DOWN_HORIZONTAL,            0xc2, L'+' },
  { BOXDRAW_DOWN_HORIZONTAL,            0x2b, L'+' },
  //{ BOXDRAW_UP_HORIZONTAL,              0xc1, L'+' },
  { BOXDRAW_UP_HORIZONTAL,              0x2b, L'+' },
